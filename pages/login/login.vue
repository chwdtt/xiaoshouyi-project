<template>
	<view class="login-wrap bg-blue">
		...
		<view class="login-form">
			<view class="username">
				<input class="uni-switch-input" placeholder="手机号/邮箱" v-model="username" placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>
			<view class="password">
				<input placeholder="输入密码" v-model="password" password=true placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>	
			<uni-button class="cu-btn bg-white margin-tb-sm lg" @tap="hanleLogin" style="width: 100%">登 录</uni-button>
			<view class="forgetPassWord" @tap="toPage('forgetPassWord')">忘记密码</view>
		</view>
		<view class="login-footer">
			<view @tap="toPage('regsiter')">注册</view>
			<view @tap="toPage('experience')">快速体验</view>
			<view @tap="toPage('setting')">设置</view>
		</view>
	</view>
</template>
